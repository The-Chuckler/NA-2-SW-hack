...
loc_1D5A2:
		...
		even
; 6 bytes per subtype it seems like
loc_1D5A8:		
...
loc_1D5BA:
		...
		moveq   #$00, D1
		move.b  $0028(A0), D1; uses subtype to control which data is getting loaded
		lea     loc_1D5A8(PC, D1), A2
		move.b  (A2)+, D1; meaning first value is unused and everything is shifted left by one
		move.l  A0, A1
		bra.s   loc_1D5F6
loc_1D5D8:		
...
loc_1D5F6:
		...
		move.b  #$04, $0001(A1); palette line 2
		move.b  #$04, $0018(A1)
		move.b  #$10, $0019(A1)
...
loc_1D68C:
		...
		cmpa.l  A0, A1
		beq.s   loc_1D69A
		jsr (DeleteObject2).l; this is where the next line meant to go...
;		jsr     (loc_D3B6); this is far from here, and its a 2p buildsprites function?
loc_1D69A:
 jmp loc_CE7C
